...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="background-color:white">
        ...
        <form id="newZakaah" runat="server" class="">
            ...
            <div class=" content" id="content"><!----content starts of Zakaah--->
            
                <button type="button" class="tablink" onclick="openPage('Zakaah', this, '#256297')" id="defaultOpen">Zakaah</button>
                <button type="button" class="tablink" onclick="openPage('Calculator', this, '#256297')" >Zakaah-Calculator</button>
                <button type="button" class="tablink" onclick="openPage('Facts', this, '#256297')">Facts</button>
                <button type="button" class="tablink" onclick="openPage('Organizations', this, '#256297')">Organizations</button>
