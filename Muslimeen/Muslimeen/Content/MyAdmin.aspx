...
<head runat="server">
    ...
    <body>
        ...
        <form id="frmScholar" runat="server" class=" " action="#">   
            <header >
                <nav class="navFixed">
                ...
                <div class="row m-0 divContainers p-2">
                    <div class=" position-static mr-2 p-0 basic-div-styling" style="min-width:250px;"> <!--contains the buttons-->
                        ...
                        <nav class="nav flex-column pt-2 pb-2 pr-0">
                            ...
                            <asp:Button runat="server" ToolTip="Pending Moderator Registrations." ID="btnViewPendingMod" CssClass="pl-2 btn mb-1 taskBtn" OnClick="btnViewPendingMod_Click" Text="View Pending Moderators"/>
                    ...
                    <div class=" col position-static p-0 basic-div-styling-2 " runat="server" id="divViewPendingSch"> <!--Contains the List of items-->
                        <div class=" head-div-2 p-2 mb-1 ">
                            <p class="m-0">Pending Registrations</p>
                        </div>
                        <div class="position-static" style="overflow-y:scroll;">
                                            ...
                                            <asp:LinkButton ID="btnShow" CommandArgument='<%#Eval("MemberID") %>' CssClass="position-static lstBtn btn btn-block" runat="server" OnClick="btnShow_Click">
                                                <div class="p-0 form-row m-0">
                                                    <div class="col-2 position-static">
                                                        <img src="MyAdmin/icons/PendingReg.png" class=" img-fluid"/>
                                                    </div>
                                                    <div class="col-10 position-static p-0">
                                                        <div class="">
                        ...
                        <asp:HiddenField runat="server" ID="hdfSchId" Value=""/>
                            ...
                            <div class=" mt-0 p-2">
                                <div class="row position-static">
                                    <div class="col position-static"><b>Member  ID:</b></div><div class="col position-static text-truncate"><label runat ="server" id="lblMemberID"></label></div>
                                </div>
                                <div class="row position-static">
                                    <div  class="col position-static"><b>Member Name:</b></div><div class="col position-static text-truncate"><label runat="server" id="lblMemberName"></label></div>
                                </div>
                                <div class="row position-static">
                                    <div  class="col position-static"><b>Member Lastname:</b></div><div class="col position-static text-truncate"><label runat="server" id="lblMemberLastName"></label></div>
                                </div>
                                <div class="row position-static">
                                    <div  class="col position-static"><b>Member DOB:</b></div><div class="col position-static text-truncate"><label runat="server" id="lblMemberDOB"></label></div>
                                </div>
                                <div class="row position-static">
                                    <div  class="col position-static"><b>Member Type:</b></div><div class="col position-static text-truncate"><label runat="server" id="lblMemberType"></label></div>
                                </div>
                                <div class="row position-static">
                                    <div class="col position-static"><b>Status:</b></div><div class="col position-static text-truncate"><label runat="server" id="lblActiveTypeID"></label></div>
                                </div>
                                <div class="row position-static">
                                    <div class="col position-static"><b>Email Address:</b></div><div class="col position-static text-truncate"><label runat="server" id="lblEmail"></label></div>
                                </div>
                                <div class="row position-static">
                                    <div class="col position-static"><b>Contact No.</b></div><div class="col position-static text-truncate"><label runat="server" id="lblContactNo"></label></div>
                                </div>
                                <div class="row position-static">
                                    <div class="col position-static"><b>Activation Expiry:</b></div><div class="col position-static text-truncate"><label runat="server" id="lblActivationExpiry"></label></div>
                                </div>
                                <div class="row position-static">
                                    <div class="col position-static"><b>Activation Date:</b></div><div class="col position-static text-truncate"><label runat="server" id="lblActivationDate"></label></div>
                                </div>
