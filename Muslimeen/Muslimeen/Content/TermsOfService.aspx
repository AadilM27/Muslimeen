            ...
            <header >
                ...
                <div class="content" id="content" style="min-height:595px;" >
                            <div class="head-div text-center p-0 mb-1">    
                                <h2 class="p-0 m-0">Terms and Policies<asp:Image runat="server" CssClass="mb-0 ml-0"  src="HelpPage/icons/docs.png" width="60" height="60"/></h2> 
                            </div> 
                    ...
                    <div class="col text-center position-static">
                       <h6>Content</h6>
                        <ul class="navbar-nav">
                           ...
                           <li class="nav-item">
                               <a class="footerr-text" href="Lear Islam/LearnIslam.aspx">Learn Islam</a>
                           </li>
                           <li class="nav-item">
