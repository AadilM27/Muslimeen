        ...
        <div>
            ...
            <asp:MultiView ID="MultiView1" ActiveViewIndex="0" runat="server">
                <asp:View ID="View1" runat="server">
                 ...
                 <table>
                <tr>
                    <td>Event Title: </td><td><asp:TextBox runat="server" ID="txtEventTitle" MaxLength="50"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>Event Date:</td><td><asp:TextBox runat="server" ID="txtEventDate"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>Event Start Time</td><td><asp:TextBox runat="server" ID="txtEventStartTime" MaxLength="20"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>Event End Time: </td><td><asp:TextBox runat="server" ID="txtEventEndTime" MaxLength="20"></asp:TextBox></td>
                </tr>
                       <tr>
                    <td>Event Speaker: </td><td><asp:TextBox runat="server" ID="txtSpeaker" MaxLength="50"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>Event Description: </td><td><asp:TextBox runat="server" ID="txtEventDescription" Width="200px" Height="150" MaxLength="250"></asp:TextBox></td>
                </tr>
                    ...
                    <asp:Repeater ID="rptUpdateEvents" runat="server">
                        <ItemTemplate>
                             <table class="table">
                                 ...
                                 <tr>
                                     <td></td><td><asp:LinkButton ID="btnSelectEvent" Text="Select Event" CssClass="btn btn-info center" runat="server" OnClick="btnSelectEvent_Click" EnableViewState="true" CommandArgument='<%#Eval("EventID")%>'/></td>
                                     </tr>
                             </table>
                            </ItemTemplate>
                        </asp:Repeater>
                   ...
                   <asp:View ID="View2" runat="server">
                       ...
                       <h3>Selected Date: <asp:Label ID="lblDate" runat="server"/></h3>
                       <h4><asp:Label ID="lblMessage" runat="server"/></h4>
                       
                            <table border="1"="table" style="justify-content: center; width: 30%; height: 20%">
                            <tbody>
                                <tr>
                                    <td rowspan="2">
