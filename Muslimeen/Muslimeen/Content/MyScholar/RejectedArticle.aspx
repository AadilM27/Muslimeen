<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RejectedArticle.aspx.cs" Inherits="Muslimeen.Content.MyScholar.RejectedArticle" %>
...
<body>
    <form id="frmRejected" runat="server">
        <!--Header-->
        <header >
                <nav class="navFixed">
        ...
        <div class="d-flex flex-row mt-2">
            <ul class="nav nav-tabs nav-tabs--vertical nav-tabs--left" role="navigation">
                ...
                <li class="nav-item">
                    <a href="RejectedArticle.aspx" class="nav-link active" data-toggle="tab" role="tab" aria-controls="dolor">Rejected Article</a>
                </li>
                <li class="nav-item">
