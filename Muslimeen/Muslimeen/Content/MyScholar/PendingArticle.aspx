<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PendingArticle.aspx.cs" Inherits="Muslimeen.Content.MyScholar.PendingArticle" %>
            ...
            <nav class="navFixed">
                ...
                <div class="row">
                    <ul class="col navbar-nav flex-row ml-4 mb-0 mt-0 pt-2 justify-content-end">
                        <li>
                            <asp:HyperLink ToolTip="Edit user profile" runat="server" ID="hplUserProfile" href="../Content/ProfileEditer.aspx" CssClass="nav-item mb-0 mr-3 user"></asp:HyperLink></li>
                    </ul>
                </div>
            </nav>
        ...
        <div class="content" id="content">
            <div class="d-flex flex-row mt-2">
                <ul class="nav nav-tabs nav-tabs--vertical nav-tabs--left" role="navigation">
                    ...
                    <li class="nav-item">
                        <a href="PendingArticle.aspx" class="nav-link active" data-toggle="tab" role="tab" aria-controls="ipsum">Pending Article</a>
                    </li>
                    <li class="nav-item">
                            ...
                            <ItemTemplate>
                                <div class="col position-static">
                                    <div class="row position-static">
                                        <div class="col-1 col-sm-3 position-static">
                                            <h5>Title:</h5>
                                        </div>
                                        <div class="col-11 col-sm-9 position-static">
